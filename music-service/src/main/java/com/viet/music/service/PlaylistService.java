...
public class PlaylistService {
	...
	public PageResponse<PlaylistResponse> getAllPlaylist(int page, int size) {
		...
		return PageResponse.<PlaylistResponse>builder().currentPage(page).pageSize(pageData.getSize())
				.totalPages(pageData.getTotalPages())
				.data(pageData.getContent().stream().map(t -> mapper.toPlaylistReponse(t)).toList()).build();
	}
